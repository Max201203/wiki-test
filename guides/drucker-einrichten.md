...
description: Anleitung zum Einrichten eines Druckers (USB/WLAN/Treiber).
tags:
  - hardware
  - drucken
  - howto
...
2. Verbindung herstellen:
   ...
   - WLAN: Im Drucker-Menü WLAN auswählen, Netzwerk und Passwort eingeben.
3. Treiber installieren:
   - Windows: Einstellungen → Geräte → Drucker hinzufügen.
   - macOS: Systemeinstellungen → Drucker & Scanner → + .
   - Linux: Druckeinstellungen → Hinzufügen → IP/URI eingeben.
